...
export default function LoadingScreen() {
  ...
  const imageTransition = (e: React.SyntheticEvent<HTMLImageElement, Event>) => {
  ...
  return (
    <>
      {isLoading && (
        <div
          className="fixed inset-0 flex items-center justify-center z-50 transition-opacity duration-1000 opacity-100"
        >
